...
const CreateStudioPage = () => {
  ...
  const handleCreateStudio = async () => {
    ...
    const scheduledAt = scheduledDetails
      ? scheduledDetails
      ...
      <main className='max-w-7xl mx-auto px-4 py-6 bg-[#111111] min-h-screen text-white'>
        ...
        <div className='flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-6'>
          <Button
            ...
            className={`${
              loading ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#8A65FD]'
            ...
            <div className='flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-3'>
              ...
              <Button
                ...
                className={`${
                  ...
                  ${
                    (!inviteeEmail.trim() || !isValidEmail(inviteeEmail)) &&
        ...
        {sessionId && hasCurrentStudioBeenCreated && isInviteSent && (
          <div className='bg-[#1A1A1A] p-6 rounded-lg my-6 text-center'>
            ...
            <p className='text-sm text-gray-400 mt-4'>
              You can manage recordings, chat, and invite more guests from
              there.
            </p>
          </div>
        )}

...
const LoginPage = () => {
  ...
  const handleLoginSubmit = async (data) => {
    ...
    try {
      // with credenitals tells send cookies with the req 
      // and also receive cookies
  ...
  // google oauth hook to handle login, shows the pop up screen and
  // when login is successful gives auth token
  const googleLogin = useGoogleLogin({
    // if login successful receives access token to fetch user info
    ...
    // user cancels or oauth error occurs
